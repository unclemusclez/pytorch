    ...
    *,
    ...
    Args:
        ...
        _disable_forced_specializations:
         Aavoids specializing to static values if set to True. For complex guards that don't specialize,
         this flag doesn't have any effect. Ideally this would be subsumed by _allow_complex_guards_as_runtime_asserts,
